...
```java
String age = "9"; String "He is S = + age + System.out.println(s); years old.";
```
...
```java
int age 9; String s "He is + age + = System.out.println(s); years old.";
```
...
public String toString() { return "Dimensions are " + width + " by " +
depth + " by " + height + ". "
}
}
class toString Demo { public static void main(String args[]) {
...
s1.equals (s4));
System.out.println(s1 + " equalsIgnoreCase " + s4 + 11
...
if (arr[i].compareTo(arr[j]) < 0) { String t = arr[j]; arr[j] = arr[i];
arr[i] = t;
}
}
...
public static void main(String args[]) { String s = "Now is the time for all good men + "to come to the aid of their country.";
System.out.println(s);
...
String search = "is"; String sub = "was";
String result ""; =
int i;
do { // replace all matching substrings System.out.println(org); i org.indexOf (search);
if(i!= -1) {
...
String str;
System.out.println("Enter 'stop' to quit."); System.out.println("Enter State: "); do {
str = br.readLine();
...
```java
// Demonstrate toUpperCase() and toLowerCase(). class Change Case 
{
public static void main(String args[]) {
...
```JAVA
// Using reverse() to reverse a StringBuffer. class ReverseDemo { public static void main(String args[]) 
{
