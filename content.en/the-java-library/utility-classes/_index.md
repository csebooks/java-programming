...
"copyright 2019";
public static void main(String args[]) { StringTokenizer st = new StringTokenizer (in, ";");
while (st.hasMoreTokens()) {
String key st.nextToken();
String val = st.nextToken(); System.out.println(key+ "\t" + val);}}}
```
...
```
// BitSet Demonstration. import java.util.BitSet;
class BitSet Demo {
public static void main(String args[]) {
BitSet bits1= new BitSet (16); BitSet bits2 = new BitSet (16);
// set some bits
for (int i=0; i<16; i++) {
}
if ((12) 0) bits1.set(i);
...
System.out.println("\nInitial pattern in bits2: "); System.out.println(bits2);
// AND bits
bits2.and (bits1);
System.out.println("\nbits2 AND bits1: ");
...
```
// Show date and time using only Date methods. import java.util.Date;
class DateDemo {
public static void main(String args[]) {
// Instantiate a Date object
Date date new Date();
// display time and date using toString() System.out.println(date);
// Display number of milliseconds since midnight, January 1, 1970 GMT long msec
date.getTime();
...
System.out.print (months [calendar.get (Calendar. MONTH)]); System.out.print (" "+calendar.get (Calendar.DATE) + " "); System.out.println(calendar.get (Calendar. YEAR));
System.out.print ("Time: ");
System.out.print (calendar.get (Calendar. HOUR)+":"); System.out.print (calendar.get (Calendar.MINUTE)+":"); System.out.println(calendar.get (Calendar. SECOND));
// Set the time and date information and display it. calendar.set (Calendar. HOUR, 10);
calendar.set (Calendar.MINUTE, 29); calendar.set (Calendar. SECOND, 22); System.out.print ("Updated time: ");
System.out.print (calendar.get (Calendar. HOUR) + ":"); System.out.print (calendar.get (Calendar.MINUTE) + " "); System.out.println(calendar.get (Calendar.SECOND));}}
```
Sample output is shown here:
...
// Display current time and date information. System.out.print ("Date: ");
System.out.print (months [gcalendar.get (Calendar.MONTH)]); System.out.print ("gcalendar.get (Calendar. DATE) + " "); System.out.println(year= gcalendar.get (Calendar. YEAR));
System.out.print ("Time: ");
...
// Test if the current year is a leap year if (gcalendar.isLeap Year (year)) {
}
...
// Demonstrate random Gaussian values. java.util.Random;
import
class RandDemo {
public static void main(String args[]) { Random = new Random();
double val;
double sum = 0;
int bell[] = new int[10];
for (int i=0; i<100; i++) {
...
Time and TimerTask implements the **Runnable** interface; thus, it can be used to  
...
```
// Demonstrate Currency. import java.util.*;
class CurDemo {
public static void main(String args[]) {
Currency c;
...
```
// A very simple example that uses Formatter. import java.util.*;
class Format Demo {
public static void main(String args[]) {
Formatter fmt new Formatter();
fmt.format("Formatting is is easy %d %f", "with Java", 10, 98.6);
...
```
// Demonstrate the f and e format specifiers. import java.util.*;
class Format Demo2 {
public static void main(String args[]) Formatter fmt new Formatter();
for (double i=1.23; i < 1.0e+6; i = 100) { fmt.format("%f te", i, i);
}
System.out.println(fmt);
fmt.close();
}
...
```
// Formatting time and date. import java.util.*;
class TimeDateFormat {
public static void main(String args[]) { Formatter fmt= new Formatter();
Calendar cal
Calendar.getInstance();
// Display standard 12-hour time format. fmt.format("str", cal); System.out.println(fmt);
fmt.close();
// Display complete time and date information. fmt= new Formatter(); fmt.format("tc", cal); System.out.println(fmt);
fmt.close();
// Display just hour and minute. fmt= new Formatter();
fmt.format("%tl: 8tM", cal, cal);
System.out.println(fmt);
fmt.close();
// Display month by name and number. fmt= new Formatter();
fmt.format("%tB stb stm", cal, cal, cal);
System.out.println(fmt);
fmt.close();}}
```
Sample output is shown here:
...
```
// Demonstrate the in and format specifiers. import java.util.*;
class Format Demo3 {
public static void main(String args[])
Formatter fmt new Formatter();
fmt.format("Copying file\nTransfer is %d8% complete", 88); System.out.println(fmt);
fmt.close();
}
...
```
// Demonstrate a field-width specifier. import java.util.*;
class Format Demo4 {
public static void main(String args[]) { Formatter fmt = new Formatter();
fmt.format("|f|tn|12f|tn|012f",
...
```
// Create a table of squares and cubes. import java.util.*;
...
```
// Demonstrate the precision modifier. import java.util.*;
class PrecisionDemo {
public static void main(String args[]) { Formatter fmt = new Formatter();
// Format 4 decimal places. fmt.format("%.4f", 123.1234567); System.out.println(fmt);
fmt.close();
// Format to 2 decimal places in a 16 character field fmt= new Formatter(); fmt.format("$16.2e", 123.1234567);
System.out.println(fmt);
fmt.close();
// Display at most 15 characters in a string. fmt= new Formatter();
...
```
// Demonstrate left justification. import java.util.*;
class LeftJustify {
public static void main(String args[]) { Formatter fmt new Formatter();
// Right justify by default fmt.format("%10.2f", 123.123); System.out.println(fmt);
fmt.close();
// Now, left justify. fmt= new Formatter();
...
```
// Demonstrate the space format specifiers. import java.util.*;
class Format Demo5 {
public static void main(String args[]) { Formatter fmt = new Formatter();
fmt.format("%d", -100); System.out.println(fmt);
fmt.close();
fmt new Formatter(); fmt.format("%d", 100); System.out.println(fmt);
fmt.close();
fmt new Formatter(); fmt.format("%d", -200); System.out.println(fmt);
fmt.close();
fmt new Formatter (); fmt.format("%d", 200); System.out.println(fmt);
fmt.close();
}}
...
```
// Use relative indexes to simplify the // creation of a custom time and date format. import java.util.*;
class Format Demo6 {
public static void main(String args[]) {
Formatter fmt new Formatter();
Calendar cal = Calendar.getInstance();
fmt.format("Today is day ste of <tB, <ty", cal);
System.out.println(fmt);
fmt.close();
}}
```
...
```
// Use automatic resource management with Formatter. import java.util.*;
class Format Demo {
public static void main(String args[]) {
try (Formatter fmt= new Formatter())
{
fmt.format("Formatting is is easy td f", "with Java", 10, 98.6);
System.out.println(fmt);}}}
```
...
while
(conin.hasNextInt()) { iconin.nextInt();
}// ...
```
...
```
// Use Scanner to compute an average of the values. import java.util.*;
class AvgNums {
public static void main(String args[]) {
Scanner conin= new Scanner(System.in);
int count = 0;
...
// Read and sum numbers. while (conin.hasNext()) {
if (conin.hasNext Double()) { sum += conin.nextDouble(); count++;
}
else {
...
```
// Use Scanner to compute an average of the values in a file. import java.util.*;
import java.io.*;
class AvgFile {
...
FileReader fin = new FileReader ("Test.txt");
Scanner src= new Scanner (fin);
// Read and sum numbers. while (src.hasNext()) {
if (src.hasNext Double()) {
}
sumsrc.nextDouble();
count++;
else {
...
// Read and sum numbers. while (src.hasNext()) {
if (src.hasNext Double()) { sum += src.nextDouble();
}
count++;
else {
String str = src.next();
...
```
// Use Scanner to read various types of data from a file. import java.util.*;
import java.io.*;
class ScanMixed {
public static void main(String args[]) throws IOException {
int i; double d;
...
// Now, store values in comma-separated list. fout.write("2, 3.4, 5,6, 7.4, 9.1, 10.5, done"); fout.close();
FileReader fin new FileReader ("Test.txt");
Scanner src= new Scanner (fin);
// Set delimiters to space and comma. src.useDelimiter (", ");
// Read and sum numbers. while (src.hasNext()) {
if (src.hasNext Double()) { sum += src.nextDouble(); count++;
}
else {
String str src.next();
if (str.equals("done")) break; else {
...
```
// Demonstrate findInLine(). import java.util.*;
...
```
import java.util.*;
public class SampleRB extends List ResourceBundle { protected Object[] [] getContents() {
...
import java.util.*;
// German version.
public class SampleRB de extends ListResourceBundle { protected Object[] [] getContents() {
Object[][] resources = new Object [3] [2];
resources [0][0] = "title";
...
```
// Demonstrate a resource bundle. import java.util.*;
class LRBDemo {
public static void main(String args[]) {
// Load the default bundle.
ResourceBundle rd ResourceBundle.getBundle ("SampleRB");
System.out.println("English version: "); System.out.println("String for Title key:*
rd.getString("title"));
...
rd
ResourceBundle.getBundle ("SampleRB", Locale. GERMAN);
System.out.println("\nGerman version: "); System.out.println("String for Title key:
rd.getString("title"));
System.out.println("String for StopText key: " +
rd.getString("StopText"));
System.out.println("String for StartText key: " +
