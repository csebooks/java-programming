...
```java
class ThreadDemo {
public static void main(String args[]) { NewThread nt = new NewThread(); // create a new thread
...
## Creating Multiple Threads
 ...
 ```java
 // Create multiple threads. class NewThread implements Runnable { String name; // name of thread
Thread t;
...
// Start the threads.
ntl.t.start(); nt2.t.start();
nt3.t.start();
try {
// wait for other threads to end Thread.sleep(10000); } catch (InterruptedException e) {
System.out.println("Main thread Interrupted");
}
System.out.println("Main thread exiting.");
}
...
public void run() { synchronized (target) { // synchronized block 
target.call (msg);
}
}
}
...
public static void main(String args[]) {
Callme target = new Callme();
Caller obl = new Caller (target, "Hello"); Caller ob2 = new Caller (target, "Synchronized");
Caller ob3 = new Caller (target, "World");
// Start the threads.
obl.t.start();
ob2.t.start();
...
class PCFixed {
public static void main(String args[]) { Qq= new Q();
...
public static void main(String args[]) { Deadlock dl = new Deadlock();
...
class SuspendResume {
public static void main(String args[]) { NewThread obl new NewThread ("One"); NewThread ob2 = new NewThread ("Two");
